...
| camunda.client.auth.*                     | no        | Any Camunda 8 authentication configuration. See [camunda8:properties-reference/camunda-client-auth](https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/properties-reference/#camundaclientauth)                    | No auth                                                                                          | n.a.                        |
